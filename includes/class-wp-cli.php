 ...
 * @package wp-cli
 */
class Nav_Menu_Importer_CLI_Command extends WP_CLI_Command
{
	...
	private function import_wxr( $file, $args ) {
		...
		if ( isset( $args['nav-menu'] ) ) {
			$wp_import = new Nav_Menu_Importer;
		} else {
...
WP_CLI::add_command( 'import', 'Nav_Menu_Importer_CLI_Command' );
